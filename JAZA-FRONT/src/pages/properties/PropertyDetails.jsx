...
function PropertyDetails({ property }) {
  ...
  let daysListed =
    Math.abs(new Date() - new Date(property.listDate).getTime()) /
    (1000 * 60 * 60 * 24);
      ...
      <Grid container padding={0} gap={3}>
        <Grid size={5}>
          <div>
            ...
            />
            <IconButton
              style={{ position: "absolute", left: 50, color: "white" }}
              aria-label="save"
              onClick={() => markFavorite(property.propertyID, user?.id)}
            >
              {favoritesList.find(
          ...
          {user?.id == property.ownerID && (
            <>
              <button
                ...
                style={{
                  backgroundColor: "rgba(210, 251, 5, 0.15)",
                  color: "blue",
                }}
                sx={{ all: `unset`, cursor: "pointer", marginBottom: `1.75em` }}
              >
                Update Property
              </button>
              <br />
              ...
              <button
                ...
                style={{
                  backgroundColor: "rgba(251, 5, 5, 0.15)",
                  color: "blue",
                }}
